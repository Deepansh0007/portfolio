...
const Contact = () => {
	...
	return (
		<div className="pt-10 px-5 pb-20" id="contact">
			<div className="flex items-center justify-center flex-col">
				<h1 className="text-3xl font-bold text-[#2B84EA]">CONTACT ME</h1>
				...
				<div className="form-control w-full max-w-lg mt-10 bg-[#1e4571] p-10 rounded-lg shadow-lg">
                    ...
                    <button className="btn w-40 mx-auto mt-10 bg-[#2B84EA] text-white text-lg border-none">Submit</button>
				</div>
			</div>
		</div>
	);
